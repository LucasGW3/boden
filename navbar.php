...
if (!function_exists('render_boden_navbar')) {
  ...
  function render_boden_navbar(string $active = '', array $opts = []): void {
    ...
    // URLs e flags
    $urlForm   = h($base . '/index.php');
    $urlDash   = h($base . '/safra_dashboard.php');
    $urlVar    = h($base . '/safra_variedade.php');
    $urlUsers  = h($base . '/users_admin.php');
    $urlLogout = h($base . '/logout.php');
    $logoSrc   = h($base . '/boden.png');
