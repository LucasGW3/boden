...
(() => {
  ...
  // Edite aqui os valores padrão e os específicos por variedade.
  // colheita = PE para produto colhido; beneficiado = PE após beneficiamento.
  const DEFAULT_PE = { colheita: 0.80, beneficiado: 1.65 };
  const PE_POR_VAR = {
    // ====== EXEMPLOS/INÍCIO (substitua pelos seus) ======
    ...
    // Ex.: 'Salto Grande':  { colheita: 1.22, beneficiado: 1.39 },
  };
